    ...
    <AnimatePresence>
      {isOpen && (
        <Dialog open={isOpen} onOpenChange={onClose}>
          <DialogContent className="max-w-2xl w-full mx-4 p-0 border-0 bg-transparent shadow-none">
            <motion.div
              ...
              style={{
                background: "linear-gradient(135deg, hsl(var(--navy-dark)) 0%, hsl(var(--navy-medium)) 50%, #1e1b4b 100%)"
              }}
            >
